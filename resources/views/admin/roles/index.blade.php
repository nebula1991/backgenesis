...
<div class="row">
    <div class="col-12 text-center">
        <h1 class="text-uppercase">Administración de Roles</h1>
    </div>
</div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <button type="button" class="btn btn-outline-primary text-uppercase" data-toggle="modal"
                                data-target="#crearRol">
                                <i class="fa fa-solid fa-key"></i> Nuevo Rol
                            </button>


                            <!-- Modal Crear Categorias -->
                            <div class="modal fade" id="crearRol" tabindex="-1" role="dialog"
                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ route('admin.roles.index') }}" method="GET" class="row g-3">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <a href="{{ route('admin.roles.index') }}"><button type="submit"
                                                ...
                                                <td style="width: 150px;">
                                                    <div class="d-flex justify-content-center">
                                                        <a class="btn btn-warning btn-sm mr-2"
                                                            href="{{route('admin.roles.edit', $rol)}}"><i
